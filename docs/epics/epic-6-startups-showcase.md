      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-body text-stone-600 max-w-2xl">
            Ventures I've founded and operated—evidence of ownership,
            decision-making, and execution under uncertainty.
          </p>
        </div>
  ...
  export function StartupDetail({ startup }: { startup: Startup }) {
    return (
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-12">
        ...
        {startup.metrics && (
          <section className="space-y-4">
            <div className="flex flex-wrap gap-6 text-body text-stone-700">
