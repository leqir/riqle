  ...
  export function CurrentContext() {
    return (
      <div className="space-y-4">
        <p className="text-body leading-relaxed text-stone-700">
          I build products, teach systems thinking, and run MarkPoint—a startup focused on [brief
          description]. My work sits at the intersection of education, product development, and
          sustainable business models.
        </p>
        <p className="text-body leading-relaxed text-stone-700">
          Right now, I'm focused on [current focus areas]—problems that require clarity, restraint,
  ...
  export function TrajectoryTimeline() {
    return (
      <div className="space-y-12">
        <h2 className="text-h2 font-semibold text-stone-900">How I got here</h2>
          ...
          {phases.map((phase, index) => (
            <div key={phase.id} className="space-y-3">
              ...
              <div className="flex items-baseline gap-3">
                <h3 className="text-h3 font-semibold text-stone-900">{phase.title}</h3>
                <span className="text-meta text-stone-500">{phase.timeframe}</span>
              </div>

              {/* What I was doing */}
              <p className="text-body text-stone-700">{phase.description}</p>

              {/* Problem exposed to */}
              <p className="text-body text-stone-600">{phase.problemExposed}</p>

              {/* What I learned */}
              <p className="text-body font-medium text-stone-800">{phase.learning}</p>
            </div>
          ))}
        </div>
      </div>
...
- [ ] Create CurrentFocus component
  ...
  export function CurrentFocus() {
    return (
      <div className="space-y-4">
        <h2 className="text-h2 font-semibold text-stone-900">What I'm focused on now</h2>

        <p className="text-body leading-relaxed text-stone-700">
          Right now, I'm working on [specific problem 1] and [specific problem 2]. These problems
          require [specific skill/approach], which aligns with my experience in [relevant phase].
        </p>

        <p className="text-body leading-relaxed text-stone-700">
          I'm particularly interested in deepening my understanding of [specific area], especially
          as it relates to [concrete application]. This work informs how I approach [current
          project/company].
        </p>
      </div>
    );
...
- [ ] Create OperatingPrinciples component
  ...
  export function OperatingPrinciples() {
    return (
      <div className="space-y-4">
        <h2 className="text-h2 font-semibold text-stone-900">How I work</h2>
...
- [ ] Optional: Add subtle hand-drawn timeline graphic
  ...
  export function TimelineGraphic() {
    return (
      <svg className="h-24 w-full opacity-30" viewBox="0 0 800 100">
...
- [ ] Add clear section headings
  ```tsx
  <h2 className="text-h2 mb-4 font-semibold text-stone-900">How I got here</h2>
  ```
...
- [ ] Add occasional emphasis (bold or italics)
  ...
  <p className="text-body text-stone-700">
    Tutoring taught me that <strong>clarity beats cleverness</strong>—most comprehension failures
    come from unnecessary complexity, not lack of intelligence.
  </p>
  ```
- [ ] Review for:
