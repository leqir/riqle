      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mt-4 text-sm leading-relaxed text-stone-600">just building stuff</p>
        ...
        <div className="mt-12 border-t border-stone-200 pt-8">
          <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            ...
            {status === 'success' ? (
              <p className="text-sm text-stone-600">you&apos;re subscribed. check your inbox.</p>
            ) : (
              <form onSubmit={handleSubscribe} className="flex w-full max-w-md gap-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-gradient-to-r from-cyan-500 to-purple-500 px-6 py-2 text-sm font-medium lowercase text-white shadow-md transition-all duration-200 hover:scale-105 hover:shadow-lg active:scale-95 disabled:cursor-not-allowed disabled:opacity-60"
                >
