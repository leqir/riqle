            ...
            <div className="rounded-xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-white p-8">
              ...
              <div className="mt-6 rounded-lg bg-blue-100 p-4">
                <p className="flex items-center gap-2 text-sm text-blue-900">
                  ...
                  <span>
                    <strong>Response time:</strong> We aim to respond within 2 business days (48
                    hours)
                  </span>
                </p>
              </div>
          ...
          <section>
            <div className="rounded-lg border border-green-200 bg-green-50 p-6">
              ...
              <p className="text-green-800">
                We&apos;re real people building this platform. We respond to every email personally,
                and we&apos;re committed to making things right if something goes wrong.
              </p>
            </div>
          </section>
