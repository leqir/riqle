/**
 * Update Module B T.S. Eliot Annotated Essay
 * Updates existing resource with comprehensive formatting and pricing
 */
...
async function updateProduct() {
  console.log('📚 Updating Module B T.S. Eliot annotated essay...\n');
  ...
  // Update the product with comprehensive content
...
<p>Instant download after purchase. The PDF is designed for deep study—print it, annotate the annotations, trace how the argument progresses from individual to civilisational to spiritual, identify analytical moves you can adapt to your own Module B text.</p>`,
      ...
      metaDescription:
        'Comprehensively annotated Band 6 exemplar essay for Module B: Critical Study of Literature. 17 pages of line-by-line analysis on T.S. Eliot Selected Poems (Rhapsody on a Windy Night, The Hollow Men, Journey of the Magi). Includes theoretical frameworks (Bergson, Weber, objective correlative) and sophisticated close reading techniques.',
    },
  });
  ...
  console.log('\n✅ Module B T.S. Eliot essay updated with comprehensive formatting!');

  await prisma.$disconnect();
}

updateProduct().catch((error) => {
